...
- <Button className="mr-2 not-prose" title="Start/continue execution" inaccessibleChildren={<Icon src="/svg/play.svg" />} />
  ...
  be disabled.
- <Button className="mr-2 not-prose" title="Pause execution" inaccessibleChildren={<Icon src="/svg/pause.svg" />} />
  If the emulator is running, use this button to pause it;
- <Button className="mr-2 not-prose" title="Build source" inaccessibleChildren={<Icon src="/svg/build.svg" />} />
