...
// code tables
  ...
  if (emulate65C02) {
    ...
    cycles[0x1E]--; extraCycles[0x1E]=1; //ASL
    cycles[0x5E]--; extraCycles[0x5E]=1; //LSR
    cycles[0x3E]--; extraCycles[0x3E]=1; //ROL
    cycles[0x7E]--; extraCycles[0x7E]=1; //ROR
  }
...
// main
  ...
  function runLoop() {
    if (jammed) return;
    step();
    if (interruptLevel<0 || !stopOnIterrupt)
      setTimeout(runLoop, internalCycleDelay);
  }
...
// external register access
  ...
  function setRegister(r, v) {
    switch(r.toLowerCase()) {
      ...
      case 'flags':
      case 'status':
      case 'sr': flags=(v&0xef)|0x20; break;
      case 'sp': sp=v&0xff; break;
      case 'pc': pc=v&0xffff; break;
    }
  }
  ...
  function usingIllegals() { return useIllegalOPCs; }

  function useRORBug(v) { emulateRORBug=!!v; }
  function usingRORBug() { return emulateRORBug; }
...
// external API
  ...
  return {
    ...
    'stopOnInterrupt': function(v) { stopOnIterrupt=!!v; },
    'getInterrupt': function() { return interruptLabels[interruptLevel]; },
    'resetInterrupt': function() { interruptLevel=-1; },
    'getCycles': function() { return processorCycles; },
    'resetCycles': function() { processorCycles=stepCycles=0; },
    'setPC': function(v) { pc=v&0xffff; },
    'getPC': function() { return pc; },
    'setSP': function(v) { sp=v&0xff; },
    'getSP': function() { return sp; },
    'setSR': function(v) { flags=v&0xef | 0x20; },
    'getSR': function() { return flags; },
    'setA': function(v) { ac=v&0xff; },
    'getA': function() { return ac; },
    'setX': function(v) { xr=v&0xff; },
    'getX': function() { return xr; },
    'setY': function(v) { yr=v&0xff; },
    'getY': function() { return yr; },
    'enableROM': function(v) { romEnabled=!!v; },
    'getSPWrap': function() { return spWrap; },
    'irq': opIRQ,
    'nmi': opNMI,
    'interrupt': function(nonMaskable) { return (nonMaskable? opNMI:opIRQ)(); },
